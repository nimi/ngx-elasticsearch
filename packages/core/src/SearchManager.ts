...
import {defaults, constant, constant, map, isEqual, get, after} from 'lodash';
...
export class SearchManager {
  ...
  static mock() {
    let searchkit = new SearchManager('/', {
      useHistory: false,
  ...
  getAccessorsByType(type: string){
    return this.accessors.getAccessorsByType(type);
  }

  getAccessorByType(type: string){
