...
var HttpClient = (function () {
    ...
    HttpClient.prototype.get = function (url, options) {
        return this.fetch.apply(this, [url, {}].concat(options, [method, 'get']));
    };
    ;
    return HttpClient;
}());
exports.HttpClient = HttpClient;
post(url, Request | string, body, any, options ?  : any);
Promise < Response > {
    console: .log(JSON.stringify(body)),
    return: this.fetch.apply(this, [url, {}].concat(options, [body, type, 'application/json', method, 'post'])) };
;
put(url, Request | string, body, any, options ?  : any);
Promise < Response > {
    return: this.fetch.apply(this, [url, {}].concat(options, [body, method, 'put'])) };
;
delete (url);
Request | string, options ?  : any;
Promise < Response > {
    return: this.fetch.apply(this, [url, {}].concat(options, [method, 'delete'])) };
;
options(url, Request | string, options ?  : any);
Promise < Response > {
    return: this.fetch.apply(this, [url, {}].concat(options, [method, 'options'])) };
;
head(url, Request | string, options ?  : any);
Promise < Response > {
    return: this.fetch.apply(this, [url, {}].concat(options, [method, 'head'])) };
;
